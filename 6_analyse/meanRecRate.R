...
lMapWin_N1 <- linkageMapWin[linkageMapWin$scaf == "N00001",]
...
recRateMeanWin <- apply(lMapWin_N1, 1, winMean, recombinationRatePerBase = recRatePerBase)

recRateMeanWin <- cbind(lMapWin_N1[,3:4], unlist(recRateMeanWin))
